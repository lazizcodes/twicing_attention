...
CUDA_VISIBLE_DEVICES=1,4,5,7 python ./src/train.py --cuda --data /path/to/data/wikitext-103/ --dataset wt103 \
...
--project_name 'PROJECT_NAME' --seed 1111 --job_name $JOB_NAME --work_dir $BASE_WORK_DIR --use_wandb